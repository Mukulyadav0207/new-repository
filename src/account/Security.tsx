      ...
      <div className="fixed  -left-56 top-14 flex items-center justify-center bg-black bg-opacity-25 backdrop-blur-[1px] w-[989px] h-[550px]">
        <div className="p-3 bg-gray-100 w-fit h-fit">
          <div className="flex gap-40 ">
            <div className="font-bold">Verify Phone Number</div>
...
const MyEmlVrfy = () => {
  return (
    <>
      <div className="fixed  -left-56 top-14 flex items-center justify-center bg-black bg-opacity-25 backdrop-blur-[1px] w-[989px] h-[610px]">
        <div className="p-3 bg-gray-100 w-fit h-fit">
          <div className="flex gap-40 ">
...
return (
  <div className="  flex flex-col rounded-md p-6 space-y-4 bg-zinc-100 w-[950px] mt-4  h-[470px]">
