...
const Fixed = () => {
  ...
  return (
    <>
      <button onClick={() => {setShowModal(true); setShowFixed(true); setShowHourly(false);}} className="">
        <GrFormAdd className="text-2xl ml-72" />
      </button>
      {showModal && <Modal />}
    </>
  );
...
export default LineItems;
    ...
    //           <input
    //             type="name"
    //             className=" mt-2 mb-2 border w-[360px] rounded-md border-gray-400"
    //           ></input>
    //         </div>
    ...
    //           <input
    //             type=""
    //             className="border rounded-md w-[360px] mt-2 mb-2 border-gray-400"
    //           ></input>
    //         </div>
