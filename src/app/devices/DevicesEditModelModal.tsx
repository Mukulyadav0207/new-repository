        ...
        <div className=" fixed inset-0 bg-black bg-opacity-25 w-[1260px] h-[665px] backdrop-blur-sm   flex justify-center items-center   ">
          <div className="p-2 bg-white border rounded-md ">
            ...
            <div className="flex-col flex items-start ">
              ...
              <div>
                <select className=" border rounded-md text-x w-[355px] mb-1 px-2 py-1.5 text-gray-400 border-gray-400">
              ...
              <label className="text-x text-[#4B5563] ">Notes</label>
              <div>
                <input
                  type="text"
                  ...
                  placeholder=""
                  className="border rounded-md   mb-1 text-xs px-2 py-1 border-gray-400 w-[355px] h-[80px]"
                ></input>
              </div>
            </div>
