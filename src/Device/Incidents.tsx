      ...
      <div>
        ...
        <div className="p-4 mt-3 bg-white border rounded-lg w-[400px]">
          <p className="p-2 border rounded-md bg-cyan-200">
            ...
            recusandae non of the it cupiditate reprehenderit, asperiores distinctio
            impedit quidem. Nisi harum porro qui impedit consequatur. Qui,
            nihil? Nemo eos sint quas quo.
          </p>
        </div>
      </div>
    );
